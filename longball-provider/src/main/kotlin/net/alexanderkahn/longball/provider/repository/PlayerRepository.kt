...
import net.alexanderkahn.longball.provider.entity.PxPlayer
...
interface PlayerRepository : LongballRepository<PxPlayer> {
    ...
    fun findByTeamIdAndOwner(pageable: Pageable, teamId: UUID, owner: EmbeddableUser = UserContext.pxUser): Page<PxPlayer>
