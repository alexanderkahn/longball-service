...
fun PxTeam.toModel(): Team {
    id as? Long ?: throw UnsupportedOperationException("Cannot convert unsaved team")
    return Team(id, abbreviation, location, nickname)
}

fun PxPlateAppearance.toModel(): PlateAppearance {
    id as? Long ?: throw UnsupportedOperationException("Cannot convert unsaved plate appearance")
